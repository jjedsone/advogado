...
export default function SitePublico() {
  ...
  return (
    <div className="site-publico">
          ...
          <div className="header-content">
            <div className="logo-section">
              <div className="logo-container">
                <span className="logo-santos">Santos</span>
                <div className="logo-advocacia-box">
                  <span className="logo-advocacia">Advocacia</span>
                </div>
              </div>
              <p className="logo-subtitle">Advogados Especializados</p>
            </div>
            ...
            <Link to="/admin" className="cta-header-btn">
      ...
      >
        ...
        <div className="container">
          <div className={`hero-content ${visibleSections.has('hero') ? 'visible' : ''}`}>
            ...
            <Link to="/admin" className="cta-hero-btn">
              <span className="chat-icon">💬</span>
              Fale com um Advogado
            </Link>
          </div>
        ...
        <div className="container">
          <div className={`conheca-content ${visibleSections.has('conheca') ? 'visible' : ''}`}>
            ...
            <div className="conheca-text">
              ...
              <p>
                O escritório Jeferson Santos Advocacia representa uma carteira diversificada 
                de clientes nacionais e internacionais, dos mais diversos setores.
              </p>
              <p>
                A JSantos Advocacia, em nosso portfólio, atendemos pessoas físicas com 
                Advogados Especialistas em Direito Civil, Direito de Família, Separação, 
                Divórcio, Dissolução de União Estável, Inventário e Partilha de Bens.
              </p>
              <p>
                O Dr. Jeferson Santos atua em Direito Imobiliário, Direito Condominial e 
                Condomínio, Empresas da construção civil, Construtoras, tecnologia, Imobiliárias, 
                Bancos, Seguradoras, Financeiras, startups, entre outras.
              </p>
      ...
      <section className="sobre-section" data-section="sobre">
        <div className="container">
          <div className={`sobre-content ${visibleSections.has('sobre') ? 'visible' : ''}`}>
            ...
            <Link to="/admin" className="cta-section-btn">
              Fale com um Advogado
            </Link>
          </div>
        </div>
      ...
      <a 
        href="https://wa.me/5511999114671" 
        target="_blank" 
